                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-main-title">
                            <h3><i class="fa-solid fa-user-group me-3"></i>List Blogs</h3>
                        </div>
                    </div>
                    <div class="col-md-12">
                                ...
                                <div class="dashboard-wrap-content p-4">
                                    <div class="d-md-flex flex-wrap align-items-center">
                                        <div class="rs ms-auto mt_r4">
                                            <a href="/admin-addblogs"><button
                                                    class="main-btn btn-hover h_40 w-100">Add Blog</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><img height="100px;" src="{{$item->thubnail}}" alt=""></td>
