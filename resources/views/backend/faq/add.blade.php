                            ...
                            <div style="margin-top:-100px;" class="step-content">
                                <div class="step-tab-panel step-tab-info active" id="tab_step1">
                                    <div class="tab-from-content">
                                        <div class="main-card">
                                            <div class="bp-title">
                                                <h4><i class="fa-solid fa-circle-info step_icon me-3"></i>Add FAQS
                                                </h4>
                                            </div>
                                            <div class="p-4 bp-form main-form">
                                                <div class="row">
                                                    <form id="eventForm" action="{{url('/admin-storefaqs')}}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="col-lg-12 col-md-12">
                                                            <div class="form-group border_bottom pb_30">
                                                                <label class="form-label fs-16">FAQ Title.*
                                                                </label>

                                                                <input class="form-control h_50" type="text"
                                                                    name="title" placeholder="Eg:- FAQ Title "
                                                                    value="">
                                                            </div>
                                                            <div class="form-group border_bottom pb_30">
                                                                <label class="form-label fs-16">Answer.*</label>
