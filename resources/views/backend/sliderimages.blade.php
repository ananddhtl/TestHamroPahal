...
<body class="d-flex flex-column h-100">
    <div class="modal fade" id="inviteTeamModal" tabindex="-1" aria-labelledby="inviteTeamModalLabel"
        ...
        <div class="modal-dialog">
            <form action="{{ url('/slider-data') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="inviteTeamModalLabel">Add Slider Image</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="model-content main-form">
                            <div class="form-group mt-30">
                                ...
                                <input class="form-control h_40" type="text" name="title" value="{{old('title')}}"
                                    placeholder="Enter Title" value="">
                            </div>
                            <div class="form-group mt-30">
                                <label class="form-label">Thumbnail</label>
                                <input class="form-control h_40" type="file" name="thumbnail" value="{{old('title')}}"
                                    placeholder="Enter Title" >
                            </div>
                            <div class="form-group mt-30">
                                <label class="form-label">Caption</label>
                                <input class="form-control h_40" type="text" name="caption" value="{{old('title')}}"
                                    placeholder="Enter Title" >
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="main-btn min-width btn-hover h_40">Submit</button>
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-main-title">
                            <h3><i class="fa-solid fa-user-group me-3"></i>List Slider Images</h3>
                        </div>
                    </div>
                    <div class="col-md-12">
                                    ...
                                    <div class="d-md-flex flex-wrap align-items-center">
                                        ...
                                        <div class="rs ms-auto mt_r4">
                                            <button class="main-btn btn-hover h_40 w-100" data-bs-toggle="modal"
                                                data-bs-target="#inviteTeamModal">Add Slider Image</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <table class="table">
                                                    <thead class="thead-dark">
                                                        <tr>
                                                            ...
                                                            <th scope="col">Has Child Page</th>
