                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-7">
                            <div class="registration">
                                <form action="{{url('/store-adminregister')}}" method="POST">
                                    @csrf
                                    <h2 class="registration-title">Admin Register</h2>
                                    <div class="form-group mt-5">
                                        <label class="form-label">Your Name*</label>
                                        <input class="form-control h_50" type="text" name="name"
                                            placeholder="Enter your email" value="{{ old('name') }}">
                                        @error('name')
