...
<body class="d-flex flex-column h-100">
    <div class="modal fade" id="inviteTeamModal" tabindex="-1" aria-labelledby="inviteTeamModalLabel"
        ...
        <div class="modal-dialog">
            <form action="{{ url('/parentpage-data') }}" method="POST">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="inviteTeamModalLabel">Add Parent Page</h5>
                    ...
                    <div class="modal-body">
                        <div class="model-content main-form">
                            ...
                            <div class="form-group mt-30">
                                <label class="form-label">Select if has child page</label>
                                <select name="ischild" class="selectpicker">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-main-title">
                            <h3><i class="fa-solid fa-user-group me-3"></i>List Parent Page</h3>
                        </div>
                    </div>
                    <div class="col-md-12">
                                    ...
                                    <div class="d-md-flex flex-wrap align-items-center">
                                        ...
                                        <div class="rs ms-auto mt_r4">
                                            <button class="main-btn btn-hover h_40 w-100" data-bs-toggle="modal"
                                                data-bs-target="#inviteTeamModal">Add Parent Page</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
