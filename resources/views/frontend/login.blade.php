                        ...
                        <div class="col-lg-10 col-md-10">
                            <div class="app-top-items">
                                ...
                                <div class="app-top-right-link">
                                    New to Hamro Pahal?<a class="sidebar-register-link" href="/register">Sign up</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-6 col-md-7">
                            <div class="registration">
                                <form action="{{ url('/userLogin') }}" method="POST">
                                    @csrf
                                    <h2 class="registration-title">Sign in to Hamro Pahal</h2>
                                ...
                                <div class="new-sign-link">
                                    New to Hamro Pahal?<a class="signup-link" href="sign_up.html">Sign up</a>
                                </div>
                            </div>
                        </div>
                    </div>
